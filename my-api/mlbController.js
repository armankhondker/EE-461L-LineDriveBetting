...
exports.index = function (req, res) {
    mlbGame.get(function (err, games) {
        ...
        res.json({
            status: "success",
            message: "mlbGames retrieved successfully",
            data: games
        });
    });
};
...
exports.new = function (req, res) {
    ...
    game.num1 = req.body.num1;
    game.num2 = req.body.num2;
...
exports.view = function (req, res) {
    mlbGame.findById(req.params.mlb_id, function (err, game) {
        if (err)
            res.send(err);
        res.json({
